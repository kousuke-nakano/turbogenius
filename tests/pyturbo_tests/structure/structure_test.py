...
def test_structure_H2():
    ...
    np.testing.assert_array_almost_equal(
        structure.cell.celldm_1, ref_celldm_1, decimal=10
    )
    np.testing.assert_array_almost_equal(
        structure.cell.celldm_2, ref_celldm_2, decimal=10
    )
    np.testing.assert_array_almost_equal(
        structure.cell.celldm_3, ref_celldm_3, decimal=10
    )
    np.testing.assert_array_almost_equal(
        structure.cell.celldm_4, ref_celldm_4, decimal=10
    )
    np.testing.assert_array_almost_equal(
        structure.cell.celldm_5, ref_celldm_5, decimal=10
    )
    np.testing.assert_array_almost_equal(
        structure.cell.celldm_6, ref_celldm_6, decimal=10
    )
    os.chdir(root_dir)


# Diamond.vasp
def test_structure_diamond_vasp():
...
# Diamond.cif
def test_structure_diamond_cif():
    os.chdir(root_dir)
...
# silicon_oxide.cif
def test_structure_silicon_oxide():
    os.chdir(root_dir)
    ...
    np.testing.assert_array_equal(structure.cell.vec_a, ref_vec_a)
    np.testing.assert_array_almost_equal(structure.cell.vec_b, ref_vec_b, decimal=10)
    np.testing.assert_array_equal(structure.cell.vec_c, ref_vec_c)
    assert structure.pbc_flag
...
def test_structure_Al_from_ASE_instance():
    os.chdir(root_dir)
    a = 4.05
    ...
    np.testing.assert_array_almost_equal(cell.vec_a, ref_vec_a, decimal=10)
    np.testing.assert_array_almost_equal(cell.vec_b, ref_vec_b, decimal=10)
    np.testing.assert_array_almost_equal(cell.vec_c, ref_vec_c, decimal=10)
    os.chdir(root_dir)
