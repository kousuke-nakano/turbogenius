...
def cli():
    ...
    parser.add_argument('--scf', help=f'scf (HF or DFT)', type=str, default="DFT", choices=["DFT", "HF"])
...
if __name__ == "__main__":
    ...
    pyscf_to_trexio_test_dir = os.path.join(turbo_genius_root, "tests", "pyscf_to_trexio")
