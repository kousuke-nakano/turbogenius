...
class Convertfort10(FortranIO):
    ...
    def run(self, input_name:str="convertfort10.input", output_name:str="out_conv"):
        """
            Run the command.
    ...
    @staticmethod
    def read_default_namelist(in_fort10:str="fort.10_in", out_fort10:str='fort.10_out'): # -> namelist
        """
    ...
    def read_namelist_from_file(file:str): # -> namelist
        ...
        return namelist
    @classmethod
    def parse_from_default_namelist(cls, in_fort10:str="fort.10_in", out_fort10:str='fort.10_out'): # -> cls
        """
            Read default namelist values from turbogenius database
    ...
    @classmethod
    def parse_from_file(cls, file:str, in_fort10:str="fort.10_in", out_fort10:str='fort.10_out'): #-> cls
        """
            Read namelist values from a specified file
