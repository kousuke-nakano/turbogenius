...
from utils.env import turbo_qmc_run_command, turbo_forcefn_run_command, turbo_forcefn_kpoints_run_command, turbo_forcefn_kpoints_para_run_command
...
class LRDMC(FortranIO):
    ...
    def get_forces(self, init=10, correct=10, bin=10, num_proc=-1, rerun=False):
        ...
        logger.info(f"The number of calculated forces = {fort10.f10forceconstraint.ieskinr}")
