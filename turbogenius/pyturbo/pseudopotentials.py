...
from utils.utility import pygetline, pygrep_lineno, return_element_symbol, return_orbchr
    ...
    def write_pseudopotential_turborvb_file(self, file="pseudo.dat"):
        with open(file, "w") as f:
            ...
            for i, nuclei_i in enumerate(set(self.nucleus_index)):
                ...
                output.append("{:14d}  {:14f}  {:14d}\n".format(nuclei_i + 1, cutoff, max_ang_mom_plus_1+1)) # ask to Sandro and Michele!!
    ...
    def parse_pseudopotential_from_turborvb_pseudo_dat(cls, file="pseudo.dat"):
        ...
        with open(file, 'rb') as f:
            ...
            while stride < len(lines):
                ...
                nuc_i=int(nuc_i)-1; r_cutoff=float(r_cutoff); max_ang_mom_plus_2=int(max_ang_mom_plus_2)
...
class Pseudopotential:
    ...
    def parse_pseudopotential_from_gamess_format_text(cls, text):
        ...
        return cls(max_ang_mom_plus_1=max_ang_mom_plus_1,
                   z_core=z_core,
                   element=element,
                   cutoff=cutoff,
                   ang_mom=ang_mom,
    ...
    @classmethod
    def parse_pseudopotential_from_turborvb_format_test(cls, text, z_core, element):
        ang_mom = []
        exponent_list = []
        coefficient_list = []
        power_list = []
    ...
    def parse_pseudopotential_from_eCEPP_format_text(cls, text):
        ...
        stride=1; local_part=True; ang_mom_i=0
...
if __name__ == "__main__":
    ...
    ## basis set downloads
    pseudopotentials_test_dir = os.path.join(pyturbo_root, "tests", "pseudopotentials")
